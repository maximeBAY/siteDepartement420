...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_contenu" runat="server">
    ...
    <asp:Image 
        ID="img_donnee" 
        ImageUrl="~/img/donnee2.png" 
        CssClass="fe_donnee"
        runat="server" 
        width="35%" />

    <h1 class="fe_titre">Portes ouvertes</h1>
    <p class="fe_txt">Le Cégep de Sept-Îles invite les élèves du secondaire ainsi que la population à sa journée 
        Portes ouvertes qui aura lieu le <strong>17 janvier 2019</strong>. Tu y découvriras une ambiance chaleureuse, des projets stimulants, 
